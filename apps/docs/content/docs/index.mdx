...
- Dive into **Components** (coming soon) when you want to compose your own layouts from primitives.
...
<Cards>
  ...
  <Card title="Customize the Search experience" href="/docs/experiences/search" />
  <Card title="Blend AskAI answers with results" href="/docs/experiences/search-askai" />
</Cards>

## What’s next

- Component reference pages
- Ready-made analytics dashboards
- Patterns for mixing structured search with RAG answers

Stay tuned—each release notes new components and migration advice.
