...
<TypeTable
  type={{
    ...
    agentStudio: {
      description: "When true, route Ask AI requests through Agent Studio endpoints. Uses API key + application ID; no chat token. When false or unset, uses default Ask AI endpoints.",
      type: "boolean",
      default: false,
      required: false,
    },
    ...
    variant: {
      ...
      type: "string",
      typeDescription: "\"floating\" | \"inline\"",
      default: "floating",
      required: false,
    },
    placeholder: {
